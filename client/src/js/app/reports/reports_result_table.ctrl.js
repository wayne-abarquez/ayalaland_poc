...
angular.module('demoApp.home')
    ...
    function reportsResultTableController ($rootScope, issuesService, lotService, $filter, SBU_SELECTION) {
        ...
        function initialize () {
            $rootScope.$on('report-type-changed', function (e, params) {
                switch(params.type) {
                    case 'ISSUES':
                        initIssuesReport(params);
                        break;
                    case 'LOTS':
                        initCLAUReport();
                        break;
        ...
        function initIssuesReport (newValue) {
